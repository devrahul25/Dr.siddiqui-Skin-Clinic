         ...
         else
         {
            if((requestcomments== "")|| (requestcomments== null))
             ...
             var data = JSON.stringify({token:"829ca790bf0d5b0ff3c82ed7c3d2c332e305eb6c",
                               ...
                               globalmedia:"https://www.drsiddiquiskinclinic.com/images/test.jpg",
                               data: [
                                 {
                                 ...
                                 template_message: [
                                   ...
                                   requesttime,
                                   requestcomments,
								   "*This is system generated message,for any queries please call ( 8802885786)*"
                                 ],
                              language: "en"
                            },
                            {
                            number: "91 8802885786",
                            template_message: [
                              requestname,
                              requestemail,
                              requestphone,
